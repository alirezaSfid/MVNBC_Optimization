...
# Set up directories
datasets_dir = "../data"
results_dir = "../results/results50points-AA"
# results_dir = "../results/results50points-GBD"
...
data_path = joinpath(datasets_dir, "demand_data_R=30.npy")
data_eval_path = joinpath(datasets_dir, "demand_data_eval_R=30.npy")
...
Data = Data[1:50, :]  # Limit to 50 data points for now
Data_eval = Data_eval[1:50, :]  # Limit to 50 data points for now
...
# println("Running Benders decomposition for R=$R, r=$r, P=$P...")
# labels, T, t, obj = BendersDecomposition.benders_algorithm_cached(X, P, K_p, r)
# end_time = now()
# elapsed_time = end_time - start_time
